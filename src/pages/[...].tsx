...
class FundPage extends Component<StoryblokEntryProps, StoryblokEntryState> {
  ...
  public render(): JSX.Element {
    ...
    return (
      <>
        ...
        <FundsDetail fond-id={this.props.fondid} tranche-id={this.props.trancheid} />
        {/* </Container> */}
        <ContactButton
...
const App = () => (
  <Router basepath="/:country/">
    <FundPage path="funds/:fondid/:trancheid" />
  </Router>
);
